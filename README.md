...
- [Fine-tune on a custom dataset](#fine-tune-on-a-custom-dataset-from-huggingface)
- [Evaluate on a dataset from huggingface](#evaluate-on-a-dataset-from-huggingface)
- [Evaluate on a custom dataset](#evaluate-on-a-custom-dataset-from-huggingface)
